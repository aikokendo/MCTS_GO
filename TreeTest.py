...
#board_instance.add_piece(1,1,game_roles.get_current_ai())
#board_instance.add_piece(2,2,game_roles.get_current_ai())
board_instance.add_piece(3,3,game_roles.get_current_ai())
print(board_instance.is_terminal(game_roles.get_current_ai()))
